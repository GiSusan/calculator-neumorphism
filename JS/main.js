...
function Input_Decimal(dot) {
    //This ensures that accidental click of the decimal point doesn't cause bugs. 
...
Update_Display(); // Calls the Update_Display function when the page first loads.
...
keys.addEventListener('click', (event) => {
  ...
  // If the clicked button is an operator button, handle it and update the display.
  ...
  // If the clicked button is a decimal button, input it and update the display.
  ...
  // If the clicked button is an all-clear button, reset the calculator and update the display.
  // This ensures that AC clears all input from the Calculator screen.
  ...
  // If the clicked button is a digit button, input the digit and update the display.
